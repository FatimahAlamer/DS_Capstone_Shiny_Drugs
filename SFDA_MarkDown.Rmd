...
HumanDrugs %>%
    mutate(Drug_Status= case_when(
     (`Manufacture Country`== "Saudi Arabia") ~ "Saudi Manufactured Drugs",
       (`Manufacture Country` != "Saudi Arabia") ~ "Non Manufactured Saudi Drugs")) -> HumanDrugs
...
labs(title = "Comparing between Saudi manufactureddrugs & non-Saudi manufactured drugs")+
...
to conculde, There are opportunities for Saudi pharmaceutical companies  to focus on syntheses of other medications that are used to treat chronic disease which is incresing!.
