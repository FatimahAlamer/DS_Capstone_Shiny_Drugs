...
## Summary 
This documents provide general description SFDA drugs with comparing to between Saudi drugs and non-Saudi drugs such as comparing  prices, drug type, route of administration. shiny app is also available which provide interactive searchable table, interactive map, plot for SFDA drugs and paracetamol calculator.   
...
Authorization Status  |  valid or suspend 
longitude | added to the original data for mapping 
latitude| added to the original data for mapping 
...
Tadalfil & SILDENAFIL used in pulmonary hypertension  but gained popularity due to use for improving erectile function.
...
NOATC %>% 
  anti_join(SATC, by = "AtcCode1") ->anti
